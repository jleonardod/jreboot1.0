  ...
  return (
    <div className="flex flex-col md:col-span-7 gap-2">
      ...
      <div className="grid grid-cols-6 gap-4">
        <div className="grid grid-cols-1 md:col-span-2 md:grid-cols-1 gap-2 pt-5 text-[1.09rem]">
          <p className="border-b-[1.5px] border-solid border-gray-400">Nuevos balances han contabilizado que hay al menos 2.600 personas muertas luego del sismo en el borde occidental de Europa.</p>
